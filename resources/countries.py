...
class Countries:
    ...
    NAME_KEYS: ClassVar[dict[str, str]] = {
        CountryCodes.ANDORRA.value: 'RES_COUNTRY.ANDORRA',
        CountryCodes.ALBANIA.value: 'RES_COUNTRY.ALBANIA',
        CountryCodes.AUSTRIA.value: 'RES_COUNTRY.AUSTRIA',
        CountryCodes.BOSNIA_AND_HERZEGOVINA.value: 'RES_COUNTRY.BOSNIA_AND_HERZEGOVINA',
        CountryCodes.BELGIUM.value: 'RES_COUNTRY.BELGIUM',
        CountryCodes.BULGARIA.value: 'RES_COUNTRY.BULGARIA',
        CountryCodes.BELARUS.value: 'RES_COUNTRY.BELARUS',
        CountryCodes.SWITZERLAND.value: 'RES_COUNTRY.SWITZERLAND',
        CountryCodes.CYPRUS.value: 'RES_COUNTRY.CYPRUS',
        CountryCodes.CZECHIA.value: 'RES_COUNTRY.CZECHIA',
        CountryCodes.GERMANY.value: 'RES_COUNTRY.GERMANY',
        CountryCodes.DENMARK.value: 'RES_COUNTRY.DENMARK',
        CountryCodes.ESTONIA.value: 'RES_COUNTRY.ESTONIA',
        CountryCodes.GREECE.value: 'RES_COUNTRY.GREECE',
        CountryCodes.SPAIN.value: 'RES_COUNTRY.SPAIN',
        CountryCodes.FINLAND.value: 'RES_COUNTRY.FINLAND',
        CountryCodes.FRANCE.value: 'RES_COUNTRY.FRANCE',
        CountryCodes.CROATIA.value: 'RES_COUNTRY.CROATIA',
        CountryCodes.HUNGARY.value: 'RES_COUNTRY.HUNGARY',
        CountryCodes.IRELAND.value: 'RES_COUNTRY.IRELAND',
        CountryCodes.ICELAND.value: 'RES_COUNTRY.ICELAND',
        CountryCodes.ITALY.value: 'RES_COUNTRY.ITALY',
        CountryCodes.LIECHTENSTEIN.value: 'RES_COUNTRY.LIECHTENSTEIN',
        CountryCodes.LITHUANIA.value: 'RES_COUNTRY.LITHUANIA',
        CountryCodes.LUXEMBOURG.value: 'RES_COUNTRY.LUXEMBOURG',
        CountryCodes.LATVIA.value: 'RES_COUNTRY.LATVIA',
        CountryCodes.MONACO.value: 'RES_COUNTRY.MONACO',
        CountryCodes.MOLDOVA.value: 'RES_COUNTRY.MOLDOVA',
        CountryCodes.MONTENEGRO.value: 'RES_COUNTRY.MONTENEGRO',
        CountryCodes.NORTH_MACEDONIA.value: 'RES_COUNTRY.NORTH_MACEDONIA',
        CountryCodes.MALTA.value: 'RES_COUNTRY.MALTA',
        CountryCodes.NETHERLANDS.value: 'RES_COUNTRY.NETHERLANDS',
        CountryCodes.NORWAY.value: 'RES_COUNTRY.NORWAY',
        CountryCodes.POLAND.value: 'RES_COUNTRY.POLAND',
        CountryCodes.PORTUGAL.value: 'RES_COUNTRY.PORTUGAL',
        CountryCodes.ROMANIA.value: 'RES_COUNTRY.ROMANIA',
        CountryCodes.SERBIA.value: 'RES_COUNTRY.SERBIA',
        CountryCodes.SWEDEN.value: 'RES_COUNTRY.SWEDEN',
        CountryCodes.SLOVENIA.value: 'RES_COUNTRY.SLOVENIA',
        CountryCodes.SLOVAKIA.value: 'RES_COUNTRY.SLOVAKIA',
        CountryCodes.SAN_MARINO.value: 'RES_COUNTRY.SAN_MARINO',
        CountryCodes.TURKIYE.value: 'RES_COUNTRY.TURKIYE',
        CountryCodes.UKRAINE.value: 'RES_COUNTRY.UKRAINE',
        CountryCodes.GREAT_BRITAIN.value: 'RES_COUNTRY.GREAT_BRITAIN',
        CountryCodes.VATICAN.value: 'RES_COUNTRY.VATICAN',
        CountryCodes.KOSOVO.value: 'RES_COUNTRY.KOSOVO'
    }
