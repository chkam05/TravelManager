...
@dataclass
class DriveThroughDataModel(BaseDataModel):
    """Stores OpenStreetMap tag values defined by OpenStreetMap AnnotationsAttr.DriveThroughAttr."""
    ...
    TAG_EMAIL: ClassVar[str] = 'drive_through:email'
    TAG_FAX: ClassVar[str] = 'drive_through:fax'
    TAG_PHONE: ClassVar[str] = 'drive_through:phone'
    TAG_SMS: ClassVar[str] = 'drive_through:sms'
    TAG_WEBSITE: ClassVar[str] = 'drive_through:website'
    ...
    @classmethod
    def from_dict(cls, d: Dict[str, Any]) -> DriveThroughDataModel:
